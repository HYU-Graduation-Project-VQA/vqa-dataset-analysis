...
# RESULT_JSON = 'logit_entropy_analysis/val_banc1280_weighted12_epoch12.json'

filename = (((RESULT_JSON.split('\/'))[-1]).split('.'))[-1]
...
if __name__ == '__main__':
    ...
    with open('{name}_result.json'.format(name=filename), 'w') as fp:
